...
export const IT_MESSAGES: Record<string, MessageValue> = {
  ...
  'whatsNew.feature.infographicExport': 'Nuove esportazioni infografiche in PNG, HTML, PDF, immagine negli appunti e Notion',
  ...
  'export.option.copyImage': 'Copia immagine',
